class Subscription < ApplicationRecord
  ...
  def pay_amount
    ...
    SubscriptionJob.set(wait_until: self&.end_date&.getutc - 3.day).perform_later(self)
    SubscriptionExpireJob.set(wait_until: self&.end_date&.getutc).perform_later(self)
  end
