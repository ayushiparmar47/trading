...
ActiveRecord::Schema.define(version: 2020_11_18_132341) do
  ...
  create_table "authentication_tokens", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "body"
    t.bigint "user_id"
